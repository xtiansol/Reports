...
public class AdminBD {
            ...
            switch (tipoBD) {
                case 0:
                    ...
                    cadenaConexion = ("data source=" 
                                ...
                                + (this.nomBD + (";" + ("integrated security=SSPI;persist security info=True;" + ("user id=" 
                                + (this.us + (";" + ("Password=" 
                                + (this.pwd + ""))))))))))));
                    break;
                case 1:
    ...
    public ArrayList  getColRegString(string sql) {
        ...
        try {
            if(tipoBD == 0 || tipoBD == 1){ //Sql Server
    ...
    // Private Function strToWindow1252(ByVal val As String) As String
    //     Dim tem As String = val
    //     Dim carTs As String = "����������@�"
    //     Dim tam As Integer = Len(val)
    //     Dim cont As Integer = 0
    //     Dim numCut As Integer = 0
    //     Dim contAux As Integer = 0
    //     While (tam > cont)
    //         Dim car As String = carTs.Substring(contAux, 1)
    //         contAux = contAux + 1
    //         numCut = numCut + (tam - Len(Replace(tem, car, "")))
    //     End While
    //     Return val.Substring(0, Len(val) - numCut)
    // End Function
    ...
    public bool ejecutaTransaccion(ArrayList querys) {
        ...
        //       querys.Count
        //       Dim cont2 = 0
        //       While cont2 < querys.Count
        //       End While
        //       for query in 
        //     $this->consulta($query);
        //     if($this->Errno!=0){
        //         $this->TxtExtraError="No se ejecuto el SQL:".$query.":";
        //         $this->ejecutaRollBack();
        //         return false;
        //     }
        // }
        // $this->ejecutaCommit();
